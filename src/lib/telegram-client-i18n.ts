...
export const BOT_STRINGS: Record<Locale, BotStringSet> = {
  ru: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (на баланс: ${c})`,
  ...
  en: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (credits: ${c})`,
  ...
  ro: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (pe sold: ${c})`,
  ...
  pl: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (na saldo: ${c})`,
  ...
  it: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (sul saldo: ${c})`,
  ...
  uz: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (balansga: ${c})`,
  ...
  kk: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (балансқа: ${c})`,
  ...
  tg: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (ба баланс: ${c})`,
  ...
  ky: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (баланска: ${c})`,
    bonusMenuButton: "🎁 Абонементтер",
  ...
  hy: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (մնացորդին՝ ${c})`,
  ...
  az: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (balansa: ${c})`,
  ...
  ka: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (ბალანსზე: ${c})`,
  ...
  tr: {
    ...
    abonementLine: (n, pr, c) => `• ${n} — ${pr} (bakiyeye: ${c})`,
