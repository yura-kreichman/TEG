                ...
                {zones.map((zone) => (
                  <PressableScale key={zone.id} className="relative">
                    <button
                      ...
                      className="relative flex w-full flex-col items-center gap-2.5 rounded-card border-[1.5px] border-border bg-card px-3 py-5 text-center shadow-[0_2px_5px_rgba(0,0,0,.15),inset_0_1px_0_rgba(255,255,255,.18),inset_0_-1px_2px_rgba(0,0,0,.09)]"
                    >
