...
# дамп три недели отдавался по прямой ссылке с кодом 200. 600 — вторая линия:
# на этой машине под тем же пользователем живут другие сайты, и файл с правами
# по умолчанию был бы читаем их кодом.
chmod 600 "$FILE"
