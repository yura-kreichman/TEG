...
export interface BotStringSet {
  ...
  // Комбинированное сообщение /join, когда вступить некуда — уже
  // состоите и/или группа не настроена, у нескольких компаний сразу
  // (запрос пользователя 2026-07-27: "человеческое сообщение... можно
  // перечислять компании"). Имя в кавычках, не склоняется — падежи
  // ненадёжны для произвольных названий компаний.
  joinAlreadyList: (names: string[]) => string;
  joinNotConfiguredList: (names: string[]) => string;
  ...
  // Именованный вариант noAbonementsAvailable — тот же принцип, что у
  // joinAlreadyList/joinNotConfiguredList выше.
  noAbonementsList: (names: string[]) => string;
...
export const BOT_STRINGS: Record<Locale, BotStringSet> = {
  ru: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Вы уже состоите в группе «${names[0]}».` : `Вы уже состоите в группах: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `У «${names[0]}» пока нет своей группы.` : `У компаний ${names.map((n) => `«${n}»`).join(", ")} пока нет своей группы.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `У «${names[0]}» пока нет абонементов.` : `У компаний ${names.map((n) => `«${n}»`).join(", ")} пока нет абонементов.`),
  ...
  en: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `You're already in "${names[0]}"'s group.` : `You're already in the groups of ${names.map((n) => `"${n}"`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `"${names[0]}" doesn't have a group yet.` : `${names.map((n) => `"${n}"`).join(", ")} don't have a group yet.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `"${names[0]}" doesn't have subscriptions yet.` : `${names.map((n) => `"${n}"`).join(", ")} don't have subscriptions yet.`),
  ...
  uk: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Ви вже в групі «${names[0]}».` : `Ви вже в групах: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `У «${names[0]}» ще немає групи.` : `У компаній ${names.map((n) => `«${n}»`).join(", ")} ще немає групи.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `У «${names[0]}» ще немає абонементів.` : `У компаній ${names.map((n) => `«${n}»`).join(", ")} ще немає абонементів.`),
  ...
  ro: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Sunteți deja în grupul „${names[0]}”.` : `Sunteți deja în grupurile: ${names.map((n) => `„${n}”`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `„${names[0]}” nu are încă un grup.` : `${names.map((n) => `„${n}”`).join(", ")} nu au încă un grup.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `„${names[0]}” nu are încă abonamente.` : `${names.map((n) => `„${n}”`).join(", ")} nu au încă abonamente.`),
  ...
  be: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Вы ўжо ў групе «${names[0]}».` : `Вы ўжо ў групах: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `У «${names[0]}» пакуль няма групы.` : `У кампаній ${names.map((n) => `«${n}»`).join(", ")} пакуль няма групы.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `У «${names[0]}» пакуль няма абанементаў.` : `У кампаній ${names.map((n) => `«${n}»`).join(", ")} пакуль няма абанементаў.`),
  ...
  pl: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Jesteś już w grupie „${names[0]}”.` : `Jesteś już w grupach: ${names.map((n) => `„${n}”`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `„${names[0]}” nie ma jeszcze grupy.` : `${names.map((n) => `„${n}”`).join(", ")} nie mają jeszcze grupy.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `„${names[0]}” nie ma jeszcze abonamentów.` : `${names.map((n) => `„${n}”`).join(", ")} nie mają jeszcze abonamentów.`),
  ...
  it: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Sei già nel gruppo «${names[0]}».` : `Sei già nei gruppi: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}» non ha ancora un gruppo.` : `${names.map((n) => `«${n}»`).join(", ")} non hanno ancora un gruppo.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}» non ha ancora abbonamenti.` : `${names.map((n) => `«${n}»`).join(", ")} non hanno ancora abbonamenti.`),
  ...
  uz: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Siz allaqachon «${names[0]}» guruhidasiz.` : `Siz allaqachon quyidagi guruhlardasiz: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}»da hali guruh yo'q.` : `${names.map((n) => `«${n}»`).join(", ")}da hali guruh yo'q.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}»da hali abonementlar yo'q.` : `${names.map((n) => `«${n}»`).join(", ")}da hali abonementlar yo'q.`),
  ...
  kk: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Сіз «${names[0]}» тобында бар екенсіз.` : `Сіз мына топтарда бар екенсіз: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}» тобы әлі жоқ.` : `${names.map((n) => `«${n}»`).join(", ")} топтары әлі жоқ.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}» абонементтері әлі жоқ.` : `${names.map((n) => `«${n}»`).join(", ")} абонементтері әлі жоқ.`),
  ...
  tg: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Шумо аллакай дар гурӯҳи «${names[0]}» ҳастед.` : `Шумо аллакай дар ин гурӯҳҳо ҳастед: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}» ҳанӯз гурӯҳ надорад.` : `${names.map((n) => `«${n}»`).join(", ")} ҳанӯз гурӯҳ надоранд.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}» ҳанӯз обуна надорад.` : `${names.map((n) => `«${n}»`).join(", ")} ҳанӯз обуна надоранд.`),
  ...
  ky: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Сиз мурунтан эле «${names[0]}» тобундасыз.` : `Сиз мурунтан эле бул топтордосуз: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}» тобу азырынча жок.` : `${names.map((n) => `«${n}»`).join(", ")} тобу азырынча жок.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}» абонементтери азырынча жок.` : `${names.map((n) => `«${n}»`).join(", ")} абонементтери азырынча жок.`),
  ...
  hy: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Դուք արդեն «${names[0]}»-ի խմբում եք.` : `Դուք արդեն այս խմբերում եք․ ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}»-ը դեռ խումբ չունի.` : `${names.map((n) => `«${n}»`).join(", ")} դեռ խումբ չունեն.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}»-ը դեռ բաժանորդագրություններ չունի.` : `${names.map((n) => `«${n}»`).join(", ")} դեռ բաժանորդագրություններ չունեն.`),
  ...
  az: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Siz artıq «${names[0]}» qrupundasınız.` : `Siz artıq bu qruplardasınız: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}»-nin hələ qrupu yoxdur.` : `${names.map((n) => `«${n}»`).join(", ")} hələ qrupu yoxdur.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}»-nin hələ abonementləri yoxdur.` : `${names.map((n) => `«${n}»`).join(", ")} hələ abonementləri yoxdur.`),
  ...
  ka: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `თქვენ უკვე ხართ «${names[0]}»-ის ჯგუფში.` : `თქვენ უკვე ხართ ამ ჯგუფებში: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}»-ს ჯერ არ აქვს ჯგუფი.` : `${names.map((n) => `«${n}»`).join(", ")} ჯერ არ აქვთ ჯგუფი.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}»-ს ჯერ არ აქვს აბონემენტები.` : `${names.map((n) => `«${n}»`).join(", ")} ჯერ არ აქვთ აბონემენტები.`),
  ...
  tr: {
    ...
    joinAlreadyList: (names) => (names.length === 1 ? `Zaten «${names[0]}» grubundasınız.` : `Zaten şu gruplardasınız: ${names.map((n) => `«${n}»`).join(", ")}.`),
    joinNotConfiguredList: (names) => (names.length === 1 ? `«${names[0]}»nin henüz grubu yok.` : `${names.map((n) => `«${n}»`).join(", ")} henüz grubu yok.`),
    ...
    noAbonementsList: (names) => (names.length === 1 ? `«${names[0]}»nin henüz aboneliği yok.` : `${names.map((n) => `«${n}»`).join(", ")} henüz aboneliği yok.`),
