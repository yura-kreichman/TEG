      ...
      >
        <div className="flex flex-col gap-3 pt-2">
          {renamingOrder && editingOrder ? (
            <form
              // Компенсация pr-2 убрана 2026-09-01 вместе с причиной: крестик
              // закрытия шторки больше не висит поверх содержимого (он в
              // потоке, в шапке BottomSheet), и ряд может занимать всю ширину
              // — залезать под крестик больше нечему.
