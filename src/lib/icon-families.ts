...
// "app-icons" — фиксированные декоративные иконки самого приложения (кнопки
// PWA оператора и т.п.), не выбираются пользователем ни в каком picker'е —
// добавлены в список только чтобы /api/icon-library/[family]/[name] их отдавал.
