...
// чтобы Сотрудник не погасил Актив не свой" — на одном активе может
        ...
        {tab === "sell" ? (
                    ...
                    >
                      ...
                      >
                        {/* min-h-[2lh] — резерв под 2 строки всегда (запрос
                            ...
                            в той же сетке. */}
                        <span className="line-clamp-2 min-h-[2lh] text-[0.8125rem] font-bold leading-tight tracking-[-0.01em] wrap-break-word">{a.name}</span>
          ...
          <>
            {/* Dropdown с тумблерами по активам + замок (запрос пользователя
                ...
                активе может стоять свой Сотрудник, на другой день один
 ...
 * несколько активов, не только один. Замок открыт — можно менять выбор
