...
export interface ZoneSummaryData {
  ...
  // Сколько ушло из кассы ДО пересчёта: расходы сотрудника плюс инкассация,
  // которую владелец сделал среди дня. Оба слагаемых входят в «Разницу», но
  // в сообщении их не было видно — и арифметика не сходилась глазами
  // (вопрос владельца 2026-09-03: «Виртуалка: касса 800, счётчики 1250,
  // Разница −100. С чего?»). Показывается только когда не ноль.
  outsideTillAmount: number;
  difference: number;
  returnsCount: number;
  operatorName: string;
