...
export function OwnerShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="flex min-h-full flex-1 flex-col" style={{ zoom: textScaleZoom(scale) }}>
      ...
      <ImpersonationBanner />
      <SubscriptionBanner />
      {/* Водяной знак логотипа — убран у Владельца окончательно (запрос
          пользователя 2026-07-27, после нескольких раундов туда-обратно).
          Остаётся только в PWA Сотрудника (operator-branding-chrome.tsx). */}
