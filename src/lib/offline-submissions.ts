...
export async function flushPendingSubmissions(): Promise<{
  ...
  for (const item of pending) {
    try {
      ...
      // 401 — не "payload не принят", а закончившаяся сессия оператора (аудит
      // 2026-07-27, второй раунд, реальная дыра: сессия тогда жила всего 12ч
      // — с 2026-09-24 бессрочна, но сотрудника могли сменить или выключить —
      // устройство, ушедшее в офлайн на закрытые выходные,
